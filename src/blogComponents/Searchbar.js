...
const Searchbar = (props) => {
    ...
    return (
        <div className={`fixed ${isSearchOpen ? '' : 'hidden'} bg-[#fff] max-w-full h-[100vh] top-0 left-0 bottom-0 right-0 shadow-md z-50 transition duration-500 ease-in-out`}>
            <button className='absolute px-2 right-0 mr-8 mt-4 py-1 text-[#203656]' onClick={toggleSearchbar}>
            ...
            <div className='h-full flex flex-col justify-center items-center'>
                ...
                <div className='md:flex gap-x-2 w-10/12 justify-center mx-auto'>
                    <input type='text' className='w-full sm:w-full md:w-[500px] rounded-[50px] border-2 border-[#34433b] p-[10px] px-[10px] mb-1 text-[#000]' placeholder='Search...' />
